...
public class DBDAO
{
	private static final Logger dbLogging = LoggerFactory.getLogger("DBLogging");

	public static ArrayList<HashMap<String, String>> get(String sResource, String sQuery,
			ArrayList<Object> aParams, boolean bUseCache)
	{
		...
		try
		{
			...
			while (rs.next())
			{
				HashMap<String, String> alRecord = new HashMap<String, String>(iColumnCount);
		...
		} finally
		{
			...
			if (c != null)
			{
				p.freeConnection(sResource, c);
			}
		}
	}

	public static int put(String sResource, String sQuery, ArrayList<Object> aParams)
	{
		DBPool p = null;
		Connection c = null;
		int iRowsAffected = 0;
	...
	public static ArrayList<HashMap<String, String>> getDBData(String sDBName, String sQuery,
			ArrayList<Object> aParams, boolean useCache, String sInvokingClass,
			String sInvokingMethod)
	{
		...
		{
			dbLogging.error(sQuery + ": " + aParams + "\nGet DB: " + sDBName + " Invoking Class: "
					+ sInvokingClass + " Method :" + sInvokingMethod + "\n"
	...
	public static int putRowsQuery(String sQuery, ArrayList<Object> aParams, String sDBName,
	...
	public static int putCommitRowsQuesry(String sQuery, ArrayList<Object> aParams,
			Connection conn, String sInvokingClass, String sInvokingMethod)
	{
	...
	public static int putTransaction(Connection conn, String sQuery, ArrayList<Object> aParams)
	{
		int iRowsAffected = 0;
		if (conn != null)
		{
	...
	public static void freeConnections(Connection conn, String sResource)
	{
		...
		if (p != null && conn != null && sResource != null && !"".equalsIgnoreCase(sResource))
		{
			p.freeConnection(sResource, conn);
		}
	}
}
