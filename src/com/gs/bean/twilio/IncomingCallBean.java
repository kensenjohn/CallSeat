...
public abstract class IncomingCallBean {
	...
	protected Integer callAttemptNumber = 0;
	...
	public Integer getCallAttemptNumber() {
		return callAttemptNumber;
	}

	public void setCallAttemptNumber(Integer callAttemptNumber) {
		this.callAttemptNumber = callAttemptNumber;
	}
