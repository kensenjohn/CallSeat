...
<%
    ...
    String sMixPanelTrackId = com.gs.common.ParseUtil.checkNull(analyticsConfig.get(Constants.ANALYTICS_KEYS.MIXPANEL_TRACKING_ID.getKey()));

    if(!"".equals(sMixPanelTrackId)) {
%>
