			...
			<div class="span11">
				<div class="row">
					...
					<div class="span3" style="text-align:right;">
						<input type="button" id="add_guest" name="add_guest" href="../event/add_guest.jsp?admin_id=<%=sAdminId %>&event_id=<%=sEventId%>" class="btn ispn3" value="Create New Guest">
					</div>
					<div class="span2" style="text-align:right;">
						<input type="button" id="invite_guest" name="invite_guest" href="../event/invite_guest.jsp?admin_id=<%=sAdminId %>&event_id=<%=sEventId%>" class="btn ispn3" value="Invite Guest from List">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="span12">
				...
				<div class="row">
					<div class="offset1 span2" style="text-align:left;">
						<input type="button" id="add_all_guests" name="add_all_guests" href="../event/add_guest.jsp?admin_id=<%=sAdminId %>&event_id=<%=sEventId%>&all_guest_tab=true" class="btn ispn3" value="Create New Guest">
					</div>
				</div>
				<div class="row">
					<div class="span8">
