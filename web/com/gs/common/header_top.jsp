...
<%
    ...
    String sProductName = com.gs.common.ParseUtil.checkNull( appConfig.get("product_name")) +" " ;
	String sPageTitle = sProductName +  com.gs.common.ParseUtil.checkNull(request.getParameter("page_title"));
