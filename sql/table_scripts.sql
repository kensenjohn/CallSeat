...
INSERT INTO GTEMAILTEMPLATE ( EMAILTEMPLATEID, EMAILTEMPLATENAME, FROM_ADDRESS_NAME, FROM_EMAIL_ADDRESS, EMAIL_SUBJECT , HTML_BODY, TEXT_BODY ) VALUES ( '88f6ab36-8455-11e1-88a0-35d635b03cf1', 'NEWPASSWORD', 'Guest Seater', 'kjwork18@gmail.com','Password Reset', 'Hello __FIRST_NAME__<br><br>We recieved a request to reset your password.<br>Please click the link or copy paste to your browser. <br>__NEW_PASSWORD_RESET_LINK__<br><br>Thanks<br>__PRODUCT_NAME__ Customer Support','Hello __FIRST_NAME__\n\nWe recieved a request to reset your password.\nPlease click the link or copy paste to your browser.\n__NEW_PASSWORD_RESET_LINK__\n\nThanks\n__PRODUCT_NAME__ Customer Support');
...
alter table GTPRICEGROUP ADD COLUMN MAX_MINUTES INT(6) NOT NULL DEFAULT 0, ADD COLUMN MIN_MINUTES INT(6) NOT NULL DEFAULT 0, ADD COLUMN  SMS_COUNT INT(6) NOT NULL DEFAULT 0;
insert into GTPRICEGROUP (PRICEGROUPID,PRICEGROUPNAME,MIN_GUEST_NUM,MAX_GUEST_NUM,MIN_MINUTES,MAX_MINUTES,SMS_COUNT,PRICE) VALUES ('f64e4d1e-5dd2-11e1-a697-592f61e300d6','Micro',0,50,0,500,250,89.00);
insert into GTPRICEGROUP (PRICEGROUPID,PRICEGROUPNAME,MIN_GUEST_NUM,MAX_GUEST_NUM,MIN_MINUTES,MAX_MINUTES,SMS_COUNT,PRICE) VALUES ('7f55012a-5dd3-11e1-bfe5-304562ecd4d0','Small',0,50,0,1250,625,149.00);
insert into GTPRICEGROUP (PRICEGROUPID,PRICEGROUPNAME,MIN_GUEST_NUM,MAX_GUEST_NUM,MIN_MINUTES,MAX_MINUTES,SMS_COUNT,PRICE) VALUES ('a976e446-5dd3-11e1-bf5a-452f61e300d6','Standard',0,50,0,2500,1300,199.00);
insert into GTPRICEGROUP (PRICEGROUPID,PRICEGROUPNAME,MIN_GUEST_NUM,MAX_GUEST_NUM,MIN_MINUTES,MAX_MINUTES,SMS_COUNT,PRICE) VALUES ('a06ffa1e-b8cb-4327-ac6f-6731679ad291','Medium',0,50,0,5000,2000,279.00);
insert into GTPRICEGROUP (PRICEGROUPID,PRICEGROUPNAME,MIN_GUEST_NUM,MAX_GUEST_NUM,MIN_MINUTES,MAX_MINUTES,SMS_COUNT,PRICE) VALUES ('022a1b19-9482-4d7c-9244-24f31be44f60','Large',0,50,0,10000,4000,459.00);
INSERT INTO GTEMAILTEMPLATE ( EMAILTEMPLATEID, EMAILTEMPLATENAME, FROM_ADDRESS_NAME, FROM_EMAIL_ADDRESS, EMAIL_SUBJECT , HTML_BODY, TEXT_BODY ) VALUES ( 'fa6ca454-80db-4d1b-a33b-5bd2373cedb7', 'NEWTELNUMBERPURCHASE', 'Guest Seater', 'kjwork18@gmail.com','Congratulations! Direct Line purchase', 'Thank you for your business. Please enjoy using the direct line for your event. <br> The new numbers are as follows: <br><br> Rsvp Number : __NEW__RSVP__TELNUM__<br> Seating Number : __NEW_SEATING__TELNUM__', 'Thank you for your business. Please enjoy using the direct line for your event. \n The new numbers are as follows: \n\n Rsvp Number : __NEW__RSVP__TELNUM__\n Seating Number : __NEW_SEATING__TELNUM__');
