...
#11/15/11
create table GTEVENTTELNUMBERS ( EVENTELNUMID VARCHAR(45) NOT NULL, FK_EVENTID VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL, RSVP_TELNUM  VARCHAR(45) NOT NULL, SEATING_TELNUM  VARCHAR(45) NOT NULL, CREATEDATE  BIGINT(20) NOT NULL DEFAULT 0, HUMANCREATEDATE   VARCHAR(45) , DEL_ROW INT(1) NOT NULL DEFAULT 0 , PRIMARY KEY (EVENTELNUMID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;

create table GTEVENTTELNUMBERS ( EVENTELNUMID VARCHAR(45) NOT NULL, FK_EVENTID VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL, FK_TELNUMBERID_RSVP  VARCHAR(45) NOT NULL, FK_TELNUMBERID_SEATING  VARCHAR(45) NOT NULL , DEL_ROW INT(1) NOT NULL DEFAULT 0 , PRIMARY KEY (EVENTELNUMID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;

create table GTTELNUMBERS ( TELNUMBERID VARCHAR(45) NOT NULL, TELNUMBER VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL, FK_TELNUMID_RSVP  VARCHAR(45) NOT NULL, FK_TELNUMID_SEATING  VARCHAR(45) NOT NULL , DEL_ROW INT(1) NOT NULL DEFAULT 0 , PRIMARY KEY (EVENTELNUMID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;

create table GTTELNUMBERTYPE (TELNUMBERTYPEID  VARCHAR(45) NOT NULL, DESCRIPTION TEXT, TYPE VARCAHR(45) NOY NULL  , PRIMARY KEY (TELNUMBERTYPEID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
