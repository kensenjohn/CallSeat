...
create table GTPURCHASETRANSACTIONS ( PURCHASETRANSACTIONID VARCHAR(45) NOT NULL, FK_EVENTID VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL, IS_PURCHASE_COMPLETE INT(1) NOT NULL DEFAULT 0, RSVP_TELNUMBER VARCHAR(45) , SEATING_TELNUMBER VARCHAR(45), FK_SUBSCRIPTIONID VARCHAR(45), FIRSTNAME TEXT, LASTNAME TEXT, ADDRESS1 TEXT, STATE TEXT, ZIPCODE VARCHAR(45), COUNTRY TEXT , STRIPE_CUSTOMER_ID TEXT, STRIPE_TOKEN TEXT, CREDIT_CARD_LAST4_DIGITS VARCHAR(45), CREATEDATE bigint(20), HUMANCREATEDATE VARCHAR(45) , PRIMARY KEY (PURCHASETRANSACTIONID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
