...
CREATE TABLE GTEMAILSCHEDULE ( EMAILSCHEDULEID VARCHAR(45) NOT NULL, FK_EMAILTEMPLATEID VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45), FK_GUESTID VARCHAR(45), CREATEDATE BIGINT(20) NOT NULL DEFAULT 0, HUMANCREATEDATE VARCHAR(45), SCHEDULEDSENDDATE BIGINT(20) NOT NULL DEFAULT 0, HUMANSCHEDULEDSENDDATE VARCHAR(45), SCHEDULE_STATUS VARCHAR(45) NOT NULL,PRIMARY KEY (EMAILSCHEDULEID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
CREATE TABLE GTSMSTEMPLATE (SMSTEMPLATEID VARCHAR(45) NOT NULL, SMSTEMPLATENAME VARCHAR(20) NOT NULL, SMS_BODY TEXT NOT NULL, PRIMARY KEY (SMSTEMPLATEID) ) ENGINE = MyISAM DEFAULT CHARSET = utf8;
INSERT INTO GTSMSTEMPLATEID (SMSTEMPLATEID,SMSTEMPLATENAME, SMS_BODY) VALUES('7548856c-f61e-48ee-b2cc-4d2f79e540e2','SMS_RSVP_CONFIRMATION','__EVENT_NAME__. Your RSVP of __NO_OF_SEAT__ was accepted.');
INSERT INTO GTSMSTEMPLATEID (SMSTEMPLATEID,SMSTEMPLATENAME, SMS_BODY) VALUES('ed3f8787-7260-43e5-a0aa-63c145eee26d','SMS_SEATING_CONFIRMATION','__EVENT_NAME__. You are seated at __TABLE_LIST__.');
