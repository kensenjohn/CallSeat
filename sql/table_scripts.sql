...
#11/30/2011
create table GTPASSWORD ( PASSWORDID VARCHAR(45) NOT NULL, PASSWORD VARCHAR(75) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL,  CREATEDATE  BIGINT(20) NOT NULL DEFAULT 0,  HUMANCREATEDATE   VARCHAR(45) , PASSWORD_STATUS VARCHAR(5) NOT NULL );
...
#02/22/2012
create table GTPRICEGROUP ( PRICEGROUPID VARCHAR(45) NOT NULL, PRICEGROUPNAME VARCHAR(45) NOT NULL, MIN_GUEST_NUM INT(10) NOT NULL DEFAULT 0, MAX_GUEST_NUM INT(10) NOT NULL DEFAULT 0,PRICE DECIMAL(10,2) NOT NULL );

create table GTEVENTPRICEGROUP ( EVENTPRICEGROUPID VARCHAR(45) NOT NULL, FK_ADMINID VARCHAR(45) NOT NULL, FK_EVENTID VARCHAR(45) NOT NULL, FK_PRICEGROUPID VARCHAR(45) NOT NULL, PURCHASE_COMPLETE INT(1) NOT NULL DEFAULT 0 );
